package com.kqp.greatendmachines.inventory;
...
public interface ProximityHopperInventory extends Inventory {
    DefaultedList<ItemStack> getItems();

    static ProximityHopperInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }

    static ProximityHopperInventory ofSize(int size) {
    ...
    default void setInvStack(int slot, ItemStack stack) {
        ...
        if (stack.getCooldown() > getInvMaxStackAmount()) {
